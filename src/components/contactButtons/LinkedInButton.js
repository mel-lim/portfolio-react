...
export const LinkedInButton = () => {
    return (
        <a href="https://www.linkedin.com/in/mel-lim-11269b1aa/" className="button-link linkedin-link" target="_blank" rel="noopener noreferrer">
            <button className="social-media-icon linkedin-icon">

                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                    width="32px" height="32px" viewBox="0 0 32 32" enable-background="new 0 0 32 32" xmlSpace="preserve">
